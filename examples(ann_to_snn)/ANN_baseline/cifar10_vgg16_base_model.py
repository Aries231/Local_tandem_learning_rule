...
from models.cifar10.vgg16 import *
...
if __name__ == '__main__':
	...
	for epoch in range(num_epochs):
		...
		if acc_test > best_acc:
			...
			torch.save(state, ckp_dir+'checkpoint/vgg16_relu2_baseline_sgd.pt')
			best_acc = acc_test
	...
	dump_json(training_record, ckp_dir, 'vgg16_baseline_train_record_relu2_sgd')