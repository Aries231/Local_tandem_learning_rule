...
from models.cifar10.vgg16 import CNN_ReluX, SpikingCNN
...
if __name__ == '__main__':
    ...
    train_record_path = 'spiking_vgg16_t{0}_tau10_L2_p{1}_offline_relu2'.format(Tencode, p)
    ...
    for epoch in range(num_epochs):
        ...
        if acc_test > best_test_acc:
            ...
            torch.save(state, snn_ckp_dir + 'checkpoint/spiking_vgg16_t{0}_tau10_L2_p{1}_offline_relu2.pt'.format(Tencode, p))
